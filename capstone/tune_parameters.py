...
Script to tune the parameters of the Kmeans algorithm with respect to the benchmark
...
clusterer1 = KMeans(n_clusters=2, random_state=1, max_iter=300)
clusterer2 = KMeans(n_clusters=2, random_state=1, max_iter=400)
clusterer3 = KMeans(n_clusters=2, random_state=1, max_iter=500)
